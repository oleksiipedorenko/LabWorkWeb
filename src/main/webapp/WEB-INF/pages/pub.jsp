...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-offset-1 col-lg-10">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active switcher"><a href="#" id="order-tab">Make an order</a></li>
                <li role="presentation" class="switcher"><a href="#" id="status-tab">Current beer status</a></li>
                <li role="presentation" class="switcher"><a href="#" id="contact-tab">Contact information</a></li>
            </ul>
        </div>
    </div>

    <div class="top-buffer tab-panel tab-content" id="order-panel">
    ...
    <div class="top-buffer tab-panel tab-content hidden" id="status-panel">
        <div class="row top-buffer">
    ...
    <div class="top-buffer tab-panel tab-content hidden" id="contact-panel">
        <div class="row top-buffer">
